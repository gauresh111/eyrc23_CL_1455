...
def main():
    ...
    positionToGO = {
      'initalPose':{'xyz': [0.0, 0.0, 0.0], 'quaternions': [0.0, 0.0, 0.0, 1.0], 'XYoffsets': [0.0, 0.0],'Yaw':180},
       'ap1': {'xyz': [-0.2, -2.45, 0.0], 'quaternions': [0.0, 0.0, 0.9999996829318346, 0.0007963267107332633], 'XYoffsets': [0.9, 0.0], 'Yaw': 3.14},
      'ap2': {'xyz': [1.5,-5.3, 0.0], 'quaternions': [0.0, 0.0, -0.706825181105366, 0.7073882691671998], 'XYoffsets': [0.0, 1.0], 'Yaw': -1.57}, 
    ...
    def add_docking_position(name, xyz, quaternions, xy_offsets,yaw,boxid):
        global positionToGO
        positionToGO[name] = {
            'xyz': xyz,
    ...
    def Rack_control_callback(Request,Response):
        ...
        add_docking_position(RackRequest,xyz,quaternions,offsetXY,yaw,boxid)
        #goes to rack
