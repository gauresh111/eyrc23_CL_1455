...
def generate_launch_description():
    ...
    xacro_file = get_package_file(moveit_config_folder_name, 'config/robotic_arm.urdf.xacro')
    urdf_file = run_xacro(xacro_file)
    robot_description_arm = load_file(urdf_file)

    srdf_file = get_package_file(moveit_config_folder_name, 'config/robotic_arm.srdf')
    ...
    moveit_servo_file = get_package_file(moveit_config_folder_name, "config/robotic_arm_servo.yaml")
    ros_controllers_file = get_package_file('robotic_arm_moveit_config', 'config/ros2_controllers.yaml')
