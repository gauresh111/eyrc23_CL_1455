...
from pymoveit2.pymoveit2.robots import robotic_arm
...
__twist_msg = TwistStamped()
__twist_msg.header.frame_id = robotic_arm.base_link_name()
...
def main():
    ...
    moveIt2 = MoveIt2Servo(node=node, frame_id=robotic_arm.base_link_name(),callback_group=callback_group)
